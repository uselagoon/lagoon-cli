...
func init() {
	...
	addDeployTargetCmd.Flags().StringP("router-pattern", "", "", "Router pattern of the DeployTarget, e.g. '${service}-${environment}-${project}.lagoon.example.com'")
	...
	updateDeployTargetCmd.Flags().StringP("router-pattern", "", "", "Router pattern of the DeployTarget, e.g. '${service}-${environment}-${project}.lagoon.example.com'")
